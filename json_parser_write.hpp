...
// ----------------------------------------------------------------------------
// There is a bug that boost property tree write_json function saves everything
// as string. This file fixed that.
...
namespace boost { namespace property_tree { namespace json_parser {
                           ...
                           int indent, bool pretty)
    {
        ...
        else if (pt.count(Str()) == pt.size()) // Removed (indent > 0 &&) for resolving parsing bug
        {
            // Write array
            stream << Ch('[');
            if (pretty) stream << Ch('\n');
